...
python3 codeInternational/translate_python.py $1 templates/python/en/text/code/*.py

python3 codeInternational/translate_templates.py $1 templates/python/en/pages/*.html
python3 codeInternational/translate_templates.py $1 templates/python/en/parts/*.html
python3 codeInternational/translate_templates.py $1 templates/python/en/programs/*.html
python3 codeInternational/translate_templates.py $1 templates/python/en/text/*.html

# we need to copy over the API json for the karel VM
cp api/python/$1.json docs/karel/js/api/python/
